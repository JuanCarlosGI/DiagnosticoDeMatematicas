...
namespace DiagnosticoDeMatematicas.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ResponseID,QuestionID,Choice")] Answer answer)
        {
            ...
            ViewBag.ResponseID = new SelectList(db.Responses, "ID", "UserID", answer.ResponseID);
            return View(answer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ResponseID,QuestionID,Choice")] Answer answer)
        {
            if (ModelState.IsValid)
            {
